...
type Tx interface {
	DefineService(request DefineServiceRequest, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	BindService(request BindServiceRequest, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	InvokeService(request InvokeServiceRequest, baseTx sdk.BaseTx) (string, sdk.ResultTx, error)
	InvokeServiceResponse(request InvokeServiceResponseRequest, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	SetWithdrawAddress(withdrawAddress string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	UpdateServiceBinding(request UpdateServiceBindingRequest, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	DisableServiceBinding(serviceName, provider string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	EnableServiceBinding(serviceName, provider string, deposit sdk.DecCoins, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	RefundServiceDeposit(serviceName, provider string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	PauseRequestContext(requestContextID string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	StartRequestContext(requestContextID string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	KillRequestContext(requestContextID string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	UpdateRequestContext(request UpdateRequestContextRequest, baseTx sdk.BaseTx) (sdk.ResultTx, error)
	WithdrawEarnedFees(provider string, baseTx sdk.BaseTx) (sdk.ResultTx, error)
